% Appendix E detection comparison (formerly main-text Fig.5).
% Copy objdec_fig5_compact.pdf beside your main manuscript, or adjust the path.
\begin{figure}[t]
    \centering
    \includegraphics[width=\linewidth]{objdec_fig5_compact.pdf}
